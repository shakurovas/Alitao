            ...
            <div class="container fs-6" >
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-inline-flex ">
                        ...
                        <b class="text-white">1 ¥ = <?=$cnyRate;?> ₽ | 1 $ = <?=$usdRate;?> ₽</b>
                    </div>
	...
	<nav class="mobile-menu__body ">
		<div class="container py-2 pb-6 d-flex flex-column flex-grow-1">
			...
			<div class="mt-8 flex-grow-1 d-flex align-items-end">
                <?php if (!$USER->IsAuthorized()):?>
                    <a href="/mobile-sing-in.html" class="btn btn-primary py-3 d-inline-flex align-items-center justify-content-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 12C13.4587 12 14.8576 11.4205 15.8891 10.3891C16.9205 9.35764 17.5 7.95869 17.5 6.5C17.5 5.04131 16.9205 3.64236 15.8891 2.61091C14.8576 1.57946 13.4587 1 12 1C10.5413 1 9.14236 1.57946 8.11091 2.61091C7.07946 3.64236 6.5 5.04131 6.5 6.5C6.5 7.95869 7.07946 9.35764 8.11091 10.3891C9.14236 11.4205 10.5413 12 12 12V12ZM15.6667 6.5C15.6667 7.47246 15.2804 8.40509 14.5927 9.09273C13.9051 9.78036 12.9725 10.1667 12 10.1667C11.0275 10.1667 10.0949 9.78036 9.40728 9.09273C8.71964 8.40509 8.33333 7.47246 8.33333 6.5C8.33333 5.52754 8.71964 4.59491 9.40728 3.90728C10.0949 3.21964 11.0275 2.83333 12 2.83333C12.9725 2.83333 13.9051 3.21964 14.5927 3.90728C15.2804 4.59491 15.6667 5.52754 15.6667 6.5V6.5ZM23 21.1667C23 23 21.1667 23 21.1667 23H2.83333C2.83333 23 1 23 1 21.1667C1 19.3333 2.83333 13.8333 12 13.8333C21.1667 13.8333 23 19.3333 23 21.1667ZM21.1667 21.1593C21.1648 20.7083 20.8843 19.3517 19.6413 18.1087C18.446 16.9133 16.1965 15.6667 12 15.6667C7.80167 15.6667 5.554 16.9133 4.35867 18.1087C3.11567 19.3517 2.837 20.7083 2.83333 21.1593H21.1667Z" fill="white"/>
                        </svg>
    ...
    <div class="modal-dialog modal-dialog-centered">
      	<div class="modal-content">
			...
			<div class="modal-body">
				<h5 class="h2 text-center mb-6"  id="singInModalLabel"><?=Loc::getMessage('LOGIN');?></h5>
				<p class="fs-5 text-center mb-7"><?=Loc::getMessage('ENTER_EMAIL_AND_PASSWORD_FOR_LOGIN');?></p>


				<form action="/" data-target="desktop-sing-in" class="mb-4">
					<div class="mb-4" data-field="login">
					...
					<div class="mb-7" data-field="password">
						<label for="sing-in-password" class="form-label"><?=Loc::getMessage('PASSWORD');?></label>
						<input type="password" class="form-control" id="sing-in-password" placeholder="<?=Loc::getMessage('ENTER_PASSWORD');?>" name="password" required>                     
					</div>
					<div class="d-flex justify-content-between align-items-center">
						<button class="btn btn-primary fs-5 px-8 py-3"><?=Loc::getMessage('LOGIN');?></button>

						<span class="fs-5 d-inline-block link-secondary" data-bs-target="#recoveryModal" data-bs-toggle="modal" data-bs-dismiss="modal"><?=Loc::getMessage('FORGOT_PASSWORD');?></span>
					</div>
				</form>
            ...
            <form action="/" data-target="desktop-sing-up" >
                ...
                <div class="form-check d-flex align-items-center mb-7">
                  ...
                  <label class="form-check-label fs-6" for="approve-ppd">
                    <?=Loc::getMessage('I_AGREE');?> <a class="link-secondary" href="/proccessing-personal-data.html" target="_blank"><?=Loc::getMessage('PROCESSING_OF_PERSONAL_DATA');?></a>
                  </label>
                </div>

                <div class="d-flex justify-content-between align-items-center">
                    <button class="btn btn-success fs-5 px-1 py-3" id="sing-up-btn"><?=Loc::getMessage('REGISTER');?></button>
                    <span class="fs-5 d-inline-block link-secondary " data-bs-target="#singInModal" data-bs-toggle="modal" data-bs-dismiss="modal"><?=Loc::getMessage('I_ALREADY_HAVE_A_PROFILE');?></span>
                </div>
            </form>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="/" data-target="desktop-reset-password">
                ...
                <!--Для Login-->
                <input type="hidden" name="login" value="test-login">
                <!--Для Login-->
        ...
        <div class="modal-body">
            ...
            <form action="/" data-target="desktop-send-question" class="mb-4">
                ...
                <div class="mb-6" data-field="contact">
                    ...
                    <input type="text" class="form-control" id="sq-contact" placeholder="<?=Loc::getMessage('USERS_CONTACT');?>" name="contact" required>                     
                </div>
                <div class="mb-6" data-field="contact">
