...
if($this->startResultCache(false, array(($USER->GetGroups()), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter, $pagerParameters, $USER->GetID()), '/s1/bitrix/news.list/user_' . $USER->GetID()))
{
