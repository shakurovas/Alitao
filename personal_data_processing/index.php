...
$APPLICATION->SetPageProperty("title", "Обработка персональных данных | Alitao.shop");
$APPLICATION->SetPageProperty("description", "Соглашение об обработки персональных данных");
