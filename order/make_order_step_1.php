        ...
        <section class="container pt-7 mt-1 pb-10 mb-4  text">
            ...
            <div class="mo-instructions <?php echo isset($_SESSION['cart']) && !empty ($_SESSION['cart']) ? 'd-none' : ''?>">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a href="mobile-add-edit-order.html" class="btn btn-primary btn-add-product-before-goods btn-add-product w-100 w-sm-auto d-md-none" ><?=Loc::getMessage('ADD_GOOD');?></a>
                </div>
